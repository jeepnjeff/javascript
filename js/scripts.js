...
// DONE  Take a number and return the square of that number (power of 2).
// DONE  If a non-number argument is passed into the function, alert NaN and prompt for another response
// DONE  In a second function, capitalize the first letter of a string and add a period (.) to the end of the string if it doesn't already end with a period
...
function caps() {
    let string = prompt('Please type in "i am awesome" below');
